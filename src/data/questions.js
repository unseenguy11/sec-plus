...
export const questionsData = {
    ...
    "unit-5": [
        ...
        { q: 'Diversion theft in cyber contexts often uses _______.', options: ['DNS spoofing to redirect to fake sites', 'ECC upgrades', '802.1X NAC', 'RAID 10'], answer: 0, explanation: 'Traffic is diverted to attacker‑controlled destinations.' },
        ...
        { q: 'Eavesdropping on networks is also called _______.', options: ['On‑path / man‑in‑the‑middle interception', 'Bluejacking', 'War‑driving', 'NFC beaming'], answer: 0, explanation: 'Adversary intercepts communications between parties.' },
