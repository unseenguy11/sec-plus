...
export const questionsData = {
    ...
    "unit-5": [
        ...
        { q: 'Which channels can social engineering operate through?', options: ['Written communication and in‑person interaction', 'Written only', 'In‑person only', 'Exclusively through encrypted communication channels'], answer: 0, explanation: 'It includes email, SMS, calls, chats, and face‑to‑face interactions.' },
        ...
        { q: '“Reset your password in the next 5 minutes or your account is deleted.” This leverages _______.', options: ['Urgency', 'Fear only', 'Social proof', 'Relying solely on the principle of scarcity to pressure victims'], answer: 0, explanation: 'Time pressure reduces scrutiny; often paired with fear.' },
        ...
        { q: 'Ransomware threatening data loss unless paid relies on _______.', options: ['Fear (often with authority pretext)', 'Relying solely on the principle of scarcity to pressure victims', 'Social proof', 'Likability'], answer: 0, explanation: 'Fear of harm is a strong motivator; sometimes paired with faux authority.' },
        ...
        { q: 'Typosquatting best describes _______.', options: ['Registering look‑alike domains with common misspellings', 'Listening in on phone calls', 'Brute‑forcing a password', 'Abusing default SSL certificates on web servers'], answer: 0, explanation: 'E.g., paypaI.com (capital i) vs paypal.com.' },
        ...
        { q: 'Pretexting relies on _______.', options: ['A fabricated scenario to elicit info or actions', 'Packet injection into TLS', 'Physical lock picking using specialized bump keys', 'Password spraying'], answer: 0, explanation: 'The story makes the request feel normal and urgent/important.' },
        ...
        { q: 'Business Email Compromise (BEC) typically involves _______.', options: ['Using a compromised internal account to request money/data', 'Only spoofed caller IDs', 'Only SMS lures', 'Exploiting default SNMP community strings on routers'], answer: 0, explanation: 'Legitimate accounts are used to send convincing requests.' },
        ...
        { q: 'Which sender detail is MOST suspicious?', options: ['Display name says “PayPal” but the actual address is random@yahoo.com', 'Display name matches the From domain', 'DMARC alignment passes', 'Email signed with a valid and trusted corporate digital certificate'], answer: 0, explanation: 'Look beyond the display name to the real From address.' },
        ...
        { q: 'A company’s anti‑phishing program should include _______.', options: ['Ongoing training + simulated campaigns + remedial training', 'A single annual memo', 'Permanently blocking all incoming email from external sources', 'Replacing MFA'], answer: 0, explanation: 'Iterative training with tests and feedback drives improvement.' },
        { q: 'Identity fraud vs identity theft: which is MOST accurate?', options: ['Fraud may use pieces of identity for transactions; theft attempts to fully assume identity', 'They are unrelated', 'Fraud requires new SSN issuance', 'Identity theft is limited exclusively to credit card fraud'], answer: 0, explanation: 'Fraud often misuses credentials; theft impersonates the person.' },
        { q: 'A classic invoice scam tries to _______.', options: ['Trick orgs into paying for unordered goods/services', 'Exploiting vulnerabilities in TLS renegotiation protocols', 'Poison ARP caches', 'Replace backup tapes'], answer: 0, explanation: 'It fabricates legitimacy with calls/emails and inflated invoices.' },
        ...
        { q: 'Digital “dumpster diving” is BEST mitigated by _______.', options: ['Secure deletion and retention policies', 'Hiding files with dots', 'Renaming extensions', 'Turning off the computer monitor when leaving the desk'], answer: 0, explanation: 'Use proper wiping/versioning; manage lifecycle.' },
        ...
        { q: 'Baiting commonly involves _______.', options: ['Malicious USB media left for victims to plug in', 'Only QR codes', 'Shoulder‑surfing', 'Performing cold-boot attacks to recover encryption keys'], answer: 0, explanation: 'Curiosity lures victims to run malware.' },
        ...
        { q: 'Which combination MOST helps against BEC?', options: ['MFA, payment verification procedures, and user training', 'Blocking all attachments', 'VPN only', 'Mandating weekly password changes for all employees'], answer: 0, explanation: 'Out‑of‑band verification + MFA + awareness reduces BEC success.' },
        { q: 'To reduce watering‑hole risk, prioritize _______.', options: ['Patch hygiene and reputation/intel feeds', 'Disabling all browsers', 'Configuring systems to accept unsigned software code', 'Turning off logs'], answer: 0, explanation: 'Keep software updated; monitor TI for compromised sites.' },
        ...
        { q: 'The BEST way to check a “LinkedIn” email request is to _______.', options: ['Open a fresh browser and navigate directly to linkedin.com', 'Click the email’s link quickly', 'Reply with your password', 'Ignoring security policy if the request seems urgent'], answer: 0, explanation: 'Validate via a known‑good path instead of embedded links.' },
        { q: 'A receptionist asked for a printer’s IP during a toner call should _______.', options: ['Refuse and route the request through policy/support channels', 'Read it over the phone', 'Immediately email the requested information to any external requester', 'Post it on a wiki'], answer: 0, explanation: 'Never divulge internal info without verification and need‑to‑know.' },
        { q: 'Which statement about simulated phishing is MOST accurate?', options: ['It provides practical practice and identifies users needing remedial training', 'It guarantees that zero phishing incidents will ever occur again', 'It replaces technical controls', 'It should be done once per decade'], answer: 0, explanation: 'Training + testing builds resilience; it complements controls.' },
        ...
        { q: 'USB drives found in parking lot and later cause infections. What failed?', options: ['User awareness and removable‑media policy', 'TLS configuration', 'Planning for Uninterruptible Power Supply capacity', 'NTP drift'], answer: 0, explanation: 'Policy/training should forbid using unknown media.' },
        { q: 'Which statement about brand impersonation is TRUE?', options: ['Logos and visual language are copied to gain trust', 'It always utilizes perfectly legitimate domain names', 'It cannot affect stock prices', 'It only occurs on email'], answer: 0, explanation: 'It happens across email/social/web and can impact markets.' },
        { q: 'Typosquatting countermeasures include _______.', options: ['Registering common misspellings and monitoring new domains', 'Relying solely on users to identify and report suspicious domains', 'Blocking all TLDs', 'Turning off DNS'], answer: 0, explanation: 'Proactive registrations + domain monitoring reduce risk.' },
        { q: 'Which is the BEST example of social proof abuse?', options: ['Fake testimonials/likes encouraging clicks', 'A prompt requesting a hardware token code', 'A signed driver', 'A DMARC reject policy'], answer: 0, explanation: 'Fabricated consensus pressures action.' },
